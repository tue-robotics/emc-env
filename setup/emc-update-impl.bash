...
then
    ...
    sudo apt-get install -y ros-$EMC_ROS_DISTRO-ros-base cmake python-catkin-pkg python-empy python-nose python-setuptools libgtest-dev build-essential ros-$EMC_ROS_DISTRO-rosbash ros-$EMC_ROS_DISTRO-catkin
